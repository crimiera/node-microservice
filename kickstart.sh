...
function setup-swarm {
  ...
  echo 'is a group of machines running Docker and joined into a cluster runned by "Swarm Manager".'  
  echo 'Swarm mangers decide a strategy to runt the swarm'  
  echo 'emptiest - fill empty machines with containers '
  echo 'global - each machine get one instance'
  echo 'only Swarm manager can authorize other machines join as nodes / workers '
  echo '···························'
