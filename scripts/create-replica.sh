...
function switchToServer {
  ...
  echo '···························'
  echo '·· swtiching >>>> '$1' server ·· run eval'
  echo '···························'
  eval $($env)
}
...
function configMongoContainer {
  ...
  # start container
  echo '·· Start Container >>>> '$1' ·· '$2'.'
  docker run --name $1 -v $2:/data -d mongo --smallfiles

  # create the folders necessary for the container
  echo '·· Create folders on the Container >>>> '$1' ··'
  docker exec -i $1 bash -c 'mkdir /data/keyfile /data/admin'

  # copy the necessary files to the container
  echo '·· Copy files to the container >>>> '$1' ··'
  copyFilesToContainer $1

  # change the permissions on the keyfile
  echo '·· Changing the file permissions for the key file >>>> '$1' ··'
